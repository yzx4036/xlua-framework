...
namespace AssetBundles
{
        ...
        public class AssetBundleManager : MonoSingleton<AssetBundleManager>
        {
                ...
                IEnumerator RunLoadFairyGUIBundle(string pFUIPackageName,  FairyGUI.UILoadCallback pCallBack)
                {
                        ...
                        string descBundleName = null;
                        string descBundleAssetName = null;
                        string resBundleName = null;
                        string resBundleAssetName = null;
                        ...
                        //        yield return null;
                        //}
                        Debug.LogError(">>>>> descBundlePath" + descBundlePath);
                        var descLoader = this.LoadAssetBundleAsync(descBundlePath);
                        yield return descLoader;
                        Debug.LogError(">>>>> descLoader finish " + descLoader.assetbundleName);
                        var resLoader = this.LoadAssetBundleAsync(resBundlePath);
                        yield return resLoader;
                        Debug.LogError(">>>>>  resLoader finish " + resLoader.assetbundle);
