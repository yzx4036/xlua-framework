...
-- 5、可将UIManager1看做一个挂载在UIRoot上的不完全UI组件，但是它是Singleton，不使用多重继承，UI组件特性隐式实现
--]]

local Messenger = require "Framework.Common.Messenger"
---@class UIManager1:Singleton
local UIManager1 = BaseClass("UIManager1", Singleton)
...
local function PopWindowStack(self)
	...
	for i = bg_index + 1, end_index  do
		local ui_name = self.__window_stack[i]
		SingleGet.UIManager1():OpenWindow(ui_name)
	end
	self.__enable_record = true
end
...
UIManager1.__init = __init
UIManager1.AddListener = AddListener
UIManager1.Broadcast = Broadcast
UIManager1.RemoveListener = RemoveListener
UIManager1.GetWindow = GetWindow
UIManager1.OpenWindow = OpenWindow
UIManager1.CloseWindow = CloseWindow
UIManager1.CloseWindowByLayer = CloseWindowByLayer
UIManager1.CloseWindowExceptLayer = CloseWindowExceptLayer
UIManager1.CloseAllWindows = CloseAllWindows
UIManager1.OpenView = OpenView
UIManager1.CloseView = CloseView
UIManager1.DestroyWindow = DestroyWindow
UIManager1.DestroyWindowByLayer = DestroyWindowByLayer
UIManager1.DestroyWindowExceptLayer = DestroyWindowExceptLayer
UIManager1.DestroyAllWindow = DestroyAllWindow
UIManager1.SetKeepModel = SetKeepModel
UIManager1.GetKeepModel = GetKeepModel
UIManager1.AddToWindowStack = AddToWindowStack
UIManager1.RemoveFormWindowStack = RemoveFormWindowStack
UIManager1.GetLastBgWindowIndexInWindowStack = GetLastBgWindowIndexInWindowStack
UIManager1.GetWindowStack = GetWindowStack
UIManager1.ClearWindowStack = ClearWindowStack
UIManager1.PopWindowStack = PopWindowStack
UIManager1.OpenOneButtonTip = OpenOneButtonTip
UIManager1.OpenTwoButtonTip = OpenTwoButtonTip
UIManager1.OpenThreeButtonTip = OpenThreeButtonTip
UIManager1.CloseTip = CloseTip
UIManager1.WaitForViewCreated = WaitForViewCreated
UIManager1.WaitForTipResponse = WaitForTipResponse
UIManager1.GetTipLastClickIndex = GetTipLastClickIndex
UIManager1.__delete = __delete
